function Button({ children, onClick, type }) {
  ...
  if (type === 'sidebar')
    className =
      'sm:px-7 px-4 py-5.25 cursor-pointer rounded-r-full bg-[#9DB37F]  text-xl text-[#F0F1E6] z-50 hover:bg-[#7d8e65]/90 transition-colors outline-none duration-500';
  ...
  if (type === 'logout')
    className =
      'cursor-pointer bg-[#fcf6bb] text-black/60 rounded-l-full sm:py-4 sm:px-8 py-2 pl-4 pr-5 font-cause sm:text-2xl text-base hover:bg-[#f7ee9e]/90 transition-colors outline-none duration-500';
  ...
  if (type === 'file')
    className = 'cursor-pointer text-black/70 sm:text-[20px] text-base hover:underline';
